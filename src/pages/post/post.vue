<template>
    <view class="wrap shadow-warp bg-white">
        ...
        >
            ...
            >
                <u-input
                    :border="border"
                    type="select"
                    :select-open="selectList.FUEL_NAME_LIST.show"
                    @click="selectList.FUEL_NAME_LIST.show = true"
                    v-model="model.FUEL_NAME"
                    placeholder="请选择车辆类型"
                ></u-input>
            </u-form-item>
            ...
            >
                <u-input
                    :border="border"
                    type="select"
                    :select-open="selectList.CAR_KIND_LIST.show"
                    @click="selectList.CAR_KIND_LIST.show = true"
                    v-model="model.CAR_KIND"
                    placeholder="请选择车辆类型"
                ></u-input>
            </u-form-item>
        ...
        <button class="cu-btn bg-green margin-tb-sm lg" @click="submit">
            提交
        </button>

        <u-select
            mode="single-column"
            :list="selectList.FUEL_NAME_LIST.data"
            v-model="selectList.FUEL_NAME_LIST.show"
            @confirm="choiceFuel"
        ></u-select>
        <u-select
            mode="single-column"
            :list="selectList.CAR_KIND_LIST.data"
            v-model="selectList.CAR_KIND_LIST.show"
            @confirm="choiceKind"
        ></u-select>
        ...
        <u-calendar
            ...
            :mode="calendar.mode"
            :start-text="calendar.startText"
            :end-text="calendar.endText"
            :range-color="calendar.rangeColor"
            :range-bg-color="calendar.rangeBgColor"
            :active-bg-color="calendar.activeBgColor"
            :btn-type="calendar.btnType"
        >
        </u-calendar>
    </view>
</template>
